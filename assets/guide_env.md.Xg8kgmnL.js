import{_ as s,o as n,i as p,aF as e}from"./chunks/framework.rUoowsLu.js";const l="/env.VITE_APP_SETTING.gif",u=JSON.parse('{"title":"环境变量","description":"","frontmatter":{},"headers":[],"relativePath":"guide/env.md","filePath":"guide/env.md"}'),i={name:"guide/env.md"};function t(o,a,c,r,d,h){return n(),p("div",null,[...a[0]||(a[0]=[e(`<div style="display:none;" hidden="true" aria-hidden="true">Are you an LLM? You can read better optimized documentation at /guide/env.md for this page in Markdown format</div><h1 id="环境变量" tabindex="-1">环境变量 <a class="header-anchor" href="#环境变量" aria-label="Permalink to &quot;环境变量&quot;">​</a></h1><p>环境变量配置文件在 <code>apps/&lt;app&gt;/</code> 根目录，默认提供三套配置，分别为：</p><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-cf_5c" id="tab-a3RNe1F" checked><label data-title=".env.development 开发环境" for="tab-a3RNe1F">.env.development 开发环境</label><input type="radio" name="group-cf_5c" id="tab-ualbUsq"><label data-title=".env.test 测试环境" for="tab-ualbUsq">.env.test 测试环境</label><input type="radio" name="group-cf_5c" id="tab-5Xaltp1"><label data-title=".env.production 生产环境" for="tab-5Xaltp1">.env.production 生产环境</label></div><div class="blocks"><div class="language-env vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">env</span><pre class="shiki shiki-themes github-light github-dark vp-code" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0"><code><span class="line"><span># 应用配置面板</span></span>
