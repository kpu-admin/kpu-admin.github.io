...
由于框架默认使用的是 Element Plus 组件库，并且演示源码中大量示例也使用了 Element Plus，如果你需要使用 [Arco Design Vue](https://arco.design/vue/docs/start)，请拉取框架源码分支，或者到 [Github Releases](https://github.com/kpu-admin/web/releases) 页面下载框架源码压缩包。
...
如果对上述的步骤还有不清楚的地方，可以访问[此仓库](https://github.com/kpu-admin/web/tree/arco-example)查看示例源码，以及[此链接](https://kpu-admin.kpui.top/arco-example/)查看示例网站。
