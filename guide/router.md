...
该配置的具体应用可参考演示站[示例](https://kpu-admin.kpui.top/kpu-example/#/pages_example/general/role)及[源码](https://github.com/kpu-admin/web/tree/example/src/views/pages_example/role)。
