...
该配置的具体应用可参考演示站[示例](https://kpu-admin.github.io/web-example/#/pages_example/general/role)及[源码](https://github.com/kpu-admin/web/tree/main/apps/example/src/views/pages_example/role)。
 ...
 * @default undefined
 * @example
 * 'https://kpu-admin.github.io/' - 在iframe中打开 Kpu-admin 官网
 ...
 * @default undefined
 * @example
 * 'https://kpu-admin.github.io/' - 在浏览器新窗口打开 Kpu-admin 官网
 */
link?: string
```
