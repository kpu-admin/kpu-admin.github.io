...
# 从 Gitcode 拉取
git clone https://gitcode.com/kpu-admin/web.git
```
...
* 在 [package.json](https://github.com/kpu-admin/web/blob/main/package.json#L6-L9) 文件中有限制 node 要求版本，建议使用最新 LTS 版本。
