...
<template>
  <div class="flex min-w-0 items-center">
    <KaDropdown align="start" side="bottom" :side-offset="10" :items="menuItems">
      <KaButton variant="ghost" class="px-3 rounded-xl flex gap-3 h-10 max-w-72 items-center">
        <span class="text-primary rounded-lg bg-primary/10 flex-center shrink-0 size-7">
          <KaIcon name="i-mdi:domain" class="size-4" />
        </span>
        ...
        <KaIcon name="i-ep:arrow-down" class="text-secondary-foreground/70 shrink-0 size-4" />
      </KaButton>
      <template #header>
...
const activityUrl = 'https://kpu-admin.github.io'
    ...
    <div class="text-white mx-auto px-4 py-3 flex flex-col gap-3 min-h-12 md:flex-row md:items-center md:justify-between">
      <div class="flex gap-3 min-w-0 items-center">
        <div class="rounded-full bg-white/14 flex-center flex-none size-9 backdrop-blur-sm">
          <KaIcon name="i-ri:rocket-2-line" class="size-5" />
        </div>
        <div class="min-w-0">
      ...
      <div class="flex flex-wrap gap-2 items-center">
        ...
        >
          查看进展
          <KaIcon name="i-ri:arrow-right-up-line" class="size-3.5" />
        </button>
        <button
    ...
    items: [
      {
        label: 'GitHub',
        value: 'kpu-admin/web',
        url: 'https://github.com/kpu-admin/web',
      },
      {
        label: 'Gitee',
        value: 'kpu-admin/web',
        url: 'https://gitee.com/kpu-admin/web',
      },
      {
        label: '开发者社区',
        value: '加入讨论',
    ...
    items: [
      {
        ...
        value: '生态产品',
        url: 'https://one-step-admin.github.io',
      },
      {
        label: 'Kpu Mobile',
        value: '移动端方案',
        url: 'https://kpu-mobile.github.io',
      },
      {
        label: '合作伙伴',
        value: '欢迎互链',
      ...
      <div ref="panelContentRef">
        <div class="mx-auto px-4 flex gap-3 h-14 items-center">
          ...
          <div class="text-xs text-muted-foreground ml-auto inline-flex flex-none gap-1 whitespace-nowrap items-center">
            <span>移入展开 / 移出收起</span>
            <KaIcon class="size-4" name="i-ri:expand-up-down-line" />
          </div>
        </div>
        <div class="mx-4 pb-4">
            ...
            >
              <div class="mb-3 flex gap-2 items-center">
                <div class="text-primary rounded-lg bg-primary/10 flex-center size-7">
                  <KaIcon :name="group.icon" class="size-4" />
                </div>
