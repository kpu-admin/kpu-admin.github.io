...
<template>
  <KaSelect v-model="value" :options placeholder="请选择..." />
</template>
```
...
<template>
  <KaSelect v-model="value" :options placeholder="选择城市" />
</template>
```
...
<template>
  <KaSelect v-model="value" :options placeholder="请选择" @change="handleChange" />
</template>
```
...
<template>
  <div class="flex flex-col gap-4">
    <KaSelect v-model="popperValue" :options="options" position="popper" />
    <KaSelect v-model="itemAlignedValue" :options="options" position="item-aligned" />
  </div>
</template>
```
...
```vue
<template>
  <KaSelect v-model="value" :options disabled />
</template>
```
...
<template>
  <form>
    <div class="flex flex-col gap-4">
      <KaSelect v-model="form.city" :options="cities" placeholder="选择城市" />
      <KaSelect v-model="form.district" :options="districts" placeholder="选择区域" :disabled="!form.city" />
    </div>
  </form>
</template>
```
