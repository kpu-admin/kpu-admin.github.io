    ...
    <template #card>
      <div class="p-4 w-64">
        <div class="flex items-center gap-3">
          <KaAvatar src="https://example.com/avatar.jpg" class="size-10 rounded-full" />
          <div>
    ...
    <template #card>
      <div class="p-4 w-80">
        <div class="flex items-start gap-3">
          <KaIcon name="i-ri:github-fill" class="size-8" />
          <div>
...
<template>
  <div class="space-y-8 p-8">
    <div class="flex gap-4">
      <KaHoverCard side="top">
        <KaButton>上方弹出</KaButton>
        <template #card>上方内容</template>
      </KaHoverCard>
      <KaHoverCard side="bottom">
        <KaButton>下方弹出</KaButton>
        <template #card>下方内容</template>
      </KaHoverCard>
    </div>
    <div class="flex gap-4">
      <KaHoverCard side="left">
        <KaButton>左侧弹出</KaButton>
        <template #card>左侧内容</template>
      </KaHoverCard>
      <KaHoverCard side="right">
        <KaButton>右侧弹出</KaButton>
