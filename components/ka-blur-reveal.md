...
```vue
<template>
  <KaBlurReveal :duration="1.5" :blur="10">
...
```vue
<template>
  <KaBlurReveal :duration="0.8" :delay="0.2">
    <KaCard v-for="i in 3" :key="i" class="p-4">
