...
* 带有语法高亮和复制功能的代码展示组件。
* 常见用法：多行代码、API 响应示例、SQL 查询示例、配合 KaCodePreview 使用。
...
```vue
<template>
  <KaCode :code="`console.log('Hello World')`" />
</template>
```
...
<template>
  <KaPageMain title="API 响应示例">
    <KaCode :code="responseCode" />
  </KaPageMain>
</template>
```
