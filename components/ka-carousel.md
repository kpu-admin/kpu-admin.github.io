...
```vue
<template>
  <KaCarousel :autoplay="{ delay: 3000 }">
    <div v-for="i in 5" :key="i" class="h-64 bg-muted flex-center">
      幻灯片 {{ i }}
    </div>
  </KaCarousel>
...
```vue
<template>
  <KaCarousel fade :autoplay="{ delay: 3000 }">
    <div v-for="i in 5" :key="i" class="h-64 bg-muted flex-center">
      幻灯片 {{ i }}
    </div>
  </KaCarousel>
...
```vue
<template>
  <KaCarousel orientation="vertical" :autoplay="{ delay: 3000 }">
    <div v-for="i in 5" :key="i" class="h-64 bg-muted flex-center">
      幻灯片 {{ i }}
    </div>
  </KaCarousel>
...
```vue
<template>
  <KaCarousel :autoplay="{ delay: 4000 }">
...
```vue
<template>
  <KaCarousel :autoplay="{ delay: 5000 }">
...
```vue
<template>
  <KaCarousel :auto-scroll="{ speed: 2 }">
...
```vue
<template>
  <KaCarousel :opts="{ align: 'start' }">
    <div v-for="i in 6" :key="i" class="pl-4">
      <KaCard :title="`卡片 ${i}`" class="w-80">
