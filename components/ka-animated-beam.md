  ...
  <div ref="containerRef" class="relative flex items-center justify-center h-100">
    <div class="flex gap-10">
      <div ref="viteRef" class="p-4 border-2 rounded-full">
        <KaIcon name="i-logos:vitejs" class="size-8" />
      </div>
      <div ref="logoRef" class="p-4 border-2 rounded-full">
        <KaIcon :name="logo" class="size-20" />
      </div>
      <div ref="vueRef" class="p-4 border-2 rounded-full">
        <KaIcon name="i-logos:vue" class="size-8" />
      </div>
    </div>
    <KaAnimatedBeam
      :container-ref="containerRef"
...
<template>
  <div ref="containerRef" class="relative h-100">
    ...
    <KaAnimatedBeam :container-ref="containerRef" :from-ref="topRef" :to-ref="centerRef" />
    <KaAnimatedBeam :container-ref="containerRef" :from-ref="bottomRef" :to-ref="centerRef" />
    <KaAnimatedBeam :container-ref="containerRef" :from-ref="leftRef" :to-ref="centerRef" />
    <KaAnimatedBeam :container-ref="containerRef" :from-ref="rightRef" :to-ref="centerRef" />
  </div>
</template>
```
