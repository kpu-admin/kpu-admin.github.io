---
url: /components/ka-flip-words.md
---
# KaFlipWords 翻转文字
...
```vue
<template>
  <KaFlipWords :words="['React', 'Vue', 'Svelte']" :duration="2000" />
</template>
```
...
<template>
  <div class="text-center py-8">
    ...
    <KaFlipWords :words="features" :duration="2500" />
  </div>
</template>
```
