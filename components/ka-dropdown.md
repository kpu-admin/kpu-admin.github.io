...
<template>
  <KaDropdown :items="items">
    <KaButton>操作</KaButton>
  </KaDropdown>
</template>
```
...
<template>
  <KaDropdown :items="items">
    <KaButton variant="outline">
      <KaIcon name="i-lucide:more-horizontal" />
    </KaButton>
  </KaDropdown>
</template>
```
...
<template>
  <KaDropdown :items="items">
    <KaAvatar src="https://example.com/avatar.jpg" class="size-8 rounded-full" />
    <template #header>
...
```vue
<template>
  <KaDropdown :items="items" side="top">
    <KaButton>向上弹出</KaButton>
  </KaDropdown>
  
  <KaDropdown :items="items" side="left">
...
<template>
  <KaDropdown :items="items">
    <div class="flex items-center gap-2 cursor-pointer">
      <KaAvatar :src="userStore.avatar" class="size-8 rounded-full" />
