---
url: /components/ka-pattern-bg.md
---
# KaPatternBg 图案背景
...
<template>
  <!-- 网格图案 -->
  <KaPatternBg variant="grid" />

  <!-- 点状图案 -->
  <KaPatternBg variant="dots" />

  <!-- 线条图案 -->
  <KaPatternBg variant="lines" />
</template>
```
...
```vue
<template>
  <KaPatternBg variant="grid" size="md" class="h-96">
...
```vue
<template>
  <KaPatternBg variant="dots" size="sm" class="h-64">
    <div class="p-6">
      <h3>点状图案</h3>
    </div>
  </KaPatternBg>
...
```vue
<template>
  <KaPatternBg mask="circle" variant="grid">
    <div class="p-6">
      圆形遮罩图案背景
    </div>
  </KaPatternBg>
