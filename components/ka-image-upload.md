...
<template>
  <KaImageUpload v-model="images" action="/api/upload">
    <div class="flex flex-col items-center justify-center size-full">
      <KaIcon name="i-lucide:image-plus" class="text-3xl text-primary mb-2" />
...
<template>
  <form class="space-y-6">
    <KaInput v-model="form.title" label="标题" />
    ...
    <KaButton @click="handleSubmit">保存</KaButton>
  </form>
</template>
```
