...
<template>
  ...
  <KaSmoothSwipe :active-index="activeIndex">
...
<template>
  ...
  <KaSmoothSwipe :active-index="currentStep">
  ...
  <div class="flex gap-2 mt-4">
    <KaButton @click="prev" :disabled="currentStep === 0">上一步</KaButton>
    <KaButton @click="next" :disabled="currentStep === steps.length - 1">
