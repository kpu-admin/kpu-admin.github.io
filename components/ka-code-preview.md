...
<template>
  <KaCodePreview title="自定义标题" :code="DemoRaw">
    <Demo />
  </KaCodePreview>
</template>
```
...
<template>
  <KaPageMain title="组件名称">
    <h2 class="text-xl font-bold mb-4">基础用法</h2>
    <KaCodePreview :code="BasicDemoRaw">
      <BasicDemo />
    </KaCodePreview>

    <h2 class="text-xl font-bold mb-4 mt-8">高级用法</h2>
    <KaCodePreview title="带配置项" :code="AdvancedDemoRaw">
      <AdvancedDemo />
    </KaCodePreview>
  </KaPageMain>
</template>
