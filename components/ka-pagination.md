...
<template>
  <KaPagination v-model:page="page" v-model:size="size" :total="total" />
</template>
```
...
<template>
  <KaPagination v-model:page="page" :total="total" />
</template>
```
...
<template>
  <KaPagination v-model:page="page" :total="total" layout="pager" />
</template>
```
...
```vue
<!-- 左侧总条数，中间页码，右侧跳转 -->
<KaPagination layout="total, ->, pager, jumper" />

<!-- 仅显示页码 -->
<KaPagination layout="pager" />

<!-- 总条数 + 每页条数 + 分页器 -->
<KaPagination layout="total, sizes, pager" />
```
