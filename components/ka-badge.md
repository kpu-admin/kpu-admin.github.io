...
<template>
  <KaBadge :value="9">
    <KaIcon name="i-ri:notification-3-line" />
  </KaBadge>
  <KaBadge :value="true">
    <KaIcon name="i-ri:notification-3-line" />
  </KaBadge>
...
```vue
<template>
  <KaBadge :value="9" variant="default">
    <KaIcon name="i-ri:notification-3-line" />
  </KaBadge>
  <KaBadge :value="9" variant="secondary">
    <KaIcon name="i-ri:notification-3-line" />
  </KaBadge>
  <KaBadge :value="9" variant="destructive">
    <KaIcon name="i-ri:notification-3-line" />
  </KaBadge>
</template>
```
