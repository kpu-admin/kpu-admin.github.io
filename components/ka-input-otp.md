---
url: /components/ka-input-otp.md
---
# KaInputOTP 验证码输入组件
...
<template>
  <KaInputOTP v-model="code" :length="4" />
</template>
```
...
<template>
  <KaInputOTP v-model="code" @complete="handleComplete" />
</template>
```
...
<template>
  <div class="space-y-4">
    <div class="flex gap-2">
      <KaInput placeholder="手机号" class="flex-1" />
      <KaButton :disabled="countdown > 0" :loading="sending" @click="sendCode">
...
<template>
  <div class="space-y-4">
    <KaInput v-model="email" type="email" placeholder="邮箱地址" />
    <div>
