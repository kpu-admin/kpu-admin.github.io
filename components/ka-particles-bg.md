...
<template>
  <div class="relative h-screen bg-gray-900">
    <KaParticlesBg color="#ffffff" :quantity="80" />
    <div class="absolute inset-0 flex items-center justify-center">
...
<template>
  <div class="relative h-96 bg-gradient-to-br from-purple-900 to-blue-900">
    <KaParticlesBg color="#fbbf24" :quantity="120" :staticity="40" />
  </div>
</template>
```
...
<template>
  <div class="relative h-64 bg-slate-800">
    <KaParticlesBg :quantity="30" :staticity="60" />
  </div>
</template>
```
...
<template>
  <div class="relative h-96 bg-black">
    <KaParticlesBg color="#00ffff" :quantity="200" :staticity="20" :ease="30" />
  </div>
</template>
```
