---
url: /components/ka-number-field.md
---
# KaNumberField 数字输入框
...
<template>
  <KaNumberField v-model="value" :min="0" :max="100" :step="5" />
</template>
```
...
<template>
  <KaNumberField v-model="value" disabled />
</template>
```
...
<template>
  <KaNumberField v-model="value" class="w-[300px]" />
</template>
```
