...
<template>
  <KaCascader v-model="value" :options placeholder="请选择" />
</template>
```
...
```vue
<KaCascader v-model="value" :options disabled />
```
...
6. z-index 默认为 2000，与 KaSelect 一致
