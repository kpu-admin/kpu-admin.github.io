---
url: /components/ka-text-shiny.md
---
# KaTextShiny 流光文字
...
```vue
<template>
  <KaTextShiny class="text-4xl font-black text-sky-600 dark:text-sky-400">
    Kpu-admin
  </KaTextShiny>
</template>
```
...
```vue
<template>
  <KaTextShiny :duration="1.1" :delay="0" class="text-3xl font-bold text-amber-600 dark:text-amber-400">
    快速扫光
  </KaTextShiny>
</template>
```
...
<template>
  <p class="text-2xl font-bold">
    适合做
    <KaTextShiny class="text-rose-600 dark:text-rose-400">
      行内重点强调
    </KaTextShiny>
    。
  </p>
